                                ...
                                <div id="order_review" style="position: relative;">
                                    <table class="shop_table">
                                        ...
                                        {	
                                            ...
                                            $arr =$this->sanpham->data[0];//lấy giá sản phẩm
                                            $total = $arr['price']*$soluong;
                                            $subtotal+=$total;
                                            ?>
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    <?=$arr['name']?> <strong class="product-quantity">× <?=$soluong?> </strong> </td>
                                                <td class="product-total">
                                                    <span class="amount">$<?=$total?> </span> </td>
                                            </tr>
                                        </tbody>
                                    <?php }
                                    ?>
