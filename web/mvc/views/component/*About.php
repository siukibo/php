<div class="about full-width page page-template-default">
					...
					<main id="main" class="site-main">
						<article class="has-post-thumbnail hentry">
							<header class="entry-header header-with-cover-image"
								style="background-image: url(assets/images/products/header-image.jpg);">
								<div class="caption">
									<h1 class="entry-title" itemprop="name">About Us</h1>
									<p class="entry-subtitle">Passion may be a friendly or eager interest in or
										admiration for a proposal, <br> cause, discovery, or activity or love to a
										feeling of unusual excitement.</p>
								</div>
							</header><!-- .entry-header -->
							...
							<div class="entry-content">
								<div class="row about-features inner-top-md inner-bottom-sm">
									<div class="col-xs-12 col-md-4">
										<figure class="wpb_wrapper vc_figure outer-bottom-xs">
											<div class="vc_single_image-wrapper">
												<img src="assets/images/blank.gif" data-echo="assets/images/column1.jpg"
									...
									<div class="col-xs-12 col-md-4">
										<figure class="wpb_wrapper vc_figure outer-bottom-xs">
											<div class="vc_single_image-wrapper">
												<img src="assets/images/blank.gif" data-echo="assets/images/column2.jpg"
													class="img-responsive" alt="">
											</div>
										</figure>
									...
									<div class="col-xs-12 col-md-4">
										<figure class="wpb_wrapper vc_figure outer-bottom-xs">
											<div class="vc_single_image-wrapper">
												<img src="assets/images/blank.gif" data-echo="assets/images/column3.jpg"
													class="img-responsive" alt="">
											</div>
										</figure>
									...
									<div class="container">
										<div class="row">
											<div class="col-sm-2">
												<div class="team-member circle">
													<img src="assets/images/blank.gif"
														data-echo="assets/images/team-member/1.jpg"
														class="img-responsive" alt="">
													<div class="profile">
											...
											<div class="col-sm-2">
												<div class="team-member circle">
													<img src="assets/images/blank.gif"
														data-echo="assets/images/team-member/2.jpg"
														class="img-responsive" alt="">
													<div class="profile">
											...
											<div class="col-sm-2">
												<div class="team-member circle">
													<img src="assets/images/blank.gif"
														data-echo="assets/images/team-member/3.jpg"
														class="img-responsive" alt="">
													<div class="profile">
											...
											<div class="col-sm-2">
												<div class="team-member circle">
													<img src="assets/images/blank.gif"
														data-echo="assets/images/team-member/4.jpg"
														class="img-responsive" alt="">
													<div class="profile">
											...
											<div class="col-sm-2">
												<div class="team-member circle">
													<img src="assets/images/blank.gif"
														data-echo="assets/images/team-member/5.jpg"
														class="img-responsive" alt="">
													<div class="profile">
											...
											<div class="col-sm-2">
												<div class="team-member circle">
													<img src="assets/images/blank.gif"
														data-echo="assets/images/team-member/7.png"
														class="img-responsive" alt="">
													<div class="profile">
										...
										<div class="row inner-bottom-xs">
											<div class="col-sm-6">
												<div class="wpb_wrapper">
													...
													<p>Donec libero dolor, tincidunt id laoreet vitae, ullamcorper eu
											...
											<div class="col-sm-6">
												<div class="wpb_wrapper">
													...
													<p>Vestibulum velit nibh, egestas vel faucibus vitae, feugiat
														sollicitudin urna. Praesent iaculis id ipsum sit amet pretium.
														Aliquam tristique sapien nec enim euismod, scelerisque facilisis
														arcu consectetur. Vestibulum velit nibh, egestas vel faucibus
														vitae.</p>
															...
															<div class="vc_tta-panel-heading">
																<h4 class="vc_tta-panel-title">
																	<a aria-controls="collapseFive"
																		aria-expanded="false" href="#collapseFive"
																		class="collapsed" data-parent="#accordion"
																		data-toggle="collapse" role="button">
																		<span class="text">Support 24/7</span>
																		<i
					...
					<div class="item">
						...
						<a href="#">
							...
							<figure>
								...
								<img src="assets/images/blank.gif" data-echo="assets/images/brands/2.png"
									class="img-responsive" alt="">
					...
					<div class="item">
						...
						<a href="#">
							...
							<figure>
								...
								<img src="assets/images/blank.gif" data-echo="assets/images/brands/3.png"
									class="img-responsive" alt="">
					...
					<div class="item">
						...
						<a href="#">
							...
							<figure>
								...
								<img src="assets/images/blank.gif" data-echo="assets/images/brands/4.png"
									class="img-responsive" alt="">
					...
					<div class="item">
						...
						<a href="#">
							...
							<figure>
								...
								<img src="assets/images/blank.gif" data-echo="assets/images/brands/5.png"
									class="img-responsive" alt="">
					...
					<div class="item">
						...
						<a href="#">
							...
							<figure>
								...
								<img src="assets/images/blank.gif" data-echo="assets/images/brands/6.png"
									class="img-responsive" alt="">
